...
export default {
	...
	core: {
		...
		'unified-search': join(__dirname, 'core/src', 'unified-search.js'),
	...
	files: {
		...
		'reference-files': join(__dirname, 'apps/files/src', 'reference-files.js'),
	},
	files_external: {
	...
	settings: {
		...
		'vue-settings-apps-users-management': join(__dirname, 'apps/settings/src', 'main-apps-users-management.js'),
	...
	updatenotification: {
		updatenotification: join(__dirname, 'apps/updatenotification/src', 'init.js'),
	},
	user_status: {
